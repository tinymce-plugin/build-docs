...
<template>
  <div class="lazyload-wrapper">
    <div style="display: flex" class="css-vem7w7 e10ne1lt2 ">
     <!-- <svg class="icon" id="logoSvgId"  viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"  p-id="5863" width="120" height="120">
...
.fv-loading svg{ 
  opacity: 0.8;
   -webkit-animation-name: loader-svg;
    -moz-animation-name: loader-svg;
    -o-animation-name: loader-svg;
